...
reinforce = REINFORCE(env, policy_network, scale=initial_scale, artificial_truncation=1024)
...
save_environment_render(rendering_env, algorithm=reinforce, save_path=os.path.join(temp_path, 'racing_trajectory'), deterministic=True, artificial_truncation=1024)
